                          ...
                          <div class="row my-2">
                            <div class="col-md-8">
                              <div class="card border-top border-success">
                                ...
                                <div class="card-body">
                                  <column-chart :data="[['January', 32], ['February', 46], ['March', 28],['April',20],['May',10],['June',2],['July',21],['August',29],['September',12],['October',20],['November',30],['December',16]]"></column-chart>
                                </div>
                              </div>
                            </div>
                              <!-- /.card -->
