                    ...
                    <!-- /.content-wrapper -->
                        <div class="content-wrapper p-2">
                                        <div class="content-header">
                                                ...
                                                <h2 class="text-md ml-4"><span class="text-lg">Currency List</span>  View / <small class="text-gray text-sm"><span>Search Items Currency </span></small></h2>
                                                <!-- alert start -->
                                                <div class="content-header">
                                                ...
                                                <div class="container-fluid">
                                                    <div class="card border-top border-primary">
                                                        <div class="card-header">
                                                                    <div class="row">
                                                                        <div class="col-md-4">
                                                                            <h1 class="display-4">Currency List</h1>
                                                                        </div> 
                                                                        <div class="col-md-6"></div> 
                                                                        <div class=" col-md-2 box-tools float-right mb-3">
                                                                            <a class="btn btn-block btn-info " href="/Currency/add">
                                                        ...
                                                        <div class="card-body">
                                                            <div class="box-body">
                                                                <!-- Start First Table List -->
                                                                    <table  class="table table-bordered table-striped dataTable dtr-inline" width="100%" role="grid"  style="width: 100%;">     
                                                                        <thead class="bg-primary ">
                                                                            <tr role="row">
                                                                                <th class="sorting" rowspan="1" colspan="1">Currency Name</th>
                                                                                <th class="sorting" rowspan="1" colspan="1">Currency Code</th>
                                                                                <th class="sorting" rowspan="1" colspan="1">Currency Symbol</th>
                                                                                <th class="sorting" rowspan="1" colspan="1">Status</th>
                                                                                <th class="sorting" rowspan="1" colspan="1">Action</th>
                                                                            </tr>
                                                                        </thead>
                                                                        <tbody>
                                                                            <tr role="row" v-for="(data,index) in currencyData" v-bind:key="data.id">
                                                                                <td>{{data.currency_name}}</td>
                                                                                <td>{{data.currency_code}}</td>
                                                                                <td>{{data.currency_symbol}}</td>
                                                                                <td>
                                                                                        <span class="label label-success" style="cursor:pointer">Active </span></td><td><div class="btn-group" title="View Account">
                                                                                            ...
                                                                                            <ul role="menu" class="dropdown-menu dropdown-light pull-right">
                                                                                                ...
                                                                                                <li>
                                                                                                    <a style="cursor:pointer" href="#" @click="deleteData(data.id,index)" title="Delete Record ?">
                                                                ...
                                                                <div class="next d-flex justify-content-between align-items-center">
                                                                    <div role="status" aria-live="polite">Showing 1 to 10 of 22 entries</div><div class="dataTables_paginate paging_simple_numbers" id="example2_paginate"></div>
...
export default {
    ...
    methods:{
        getCurrencyData: function(){
            axios.get("http://192.168.100.9/Project_Laravel/public/api/currency")
                // return promise
            .then((res)=>{
        ...
        deleteData: function(id,index) {
            ...
            axios.delete('http://192.168.100.9/Project_Laravel/public/api/currency/' + id)
            .then((res)=>{
                console.log(res);
            })
            // catch error
