                    ...
                    <!-- /.content-wrapper -->
                        <div class="content-wrapper p-2">
                                    <div class="content-header">
                                                            ...
                                                            <h2 class="text-md ml-4"><span class="text-lg">Users List </span>  Add / <small class="text-gray text-sm"><span>Update Users</span></small></h2>
                                                            <!-- alert start -->
                                                            <div class="content-header">
                                                            ...
                                                            <div class="card border-top border-primary">
                                                                    ...
                                                                    <div class="card-body">
                                                                        <div class="box-body">
                                                                            <table id="example2" class="table table-bordered table-striped dataTable dtr-inline" width="100%" role="grid" aria-describedby="example2_info" style="width: 100%;">
                                                                                <thead class="bg-primary ">
                                                                                    <tr role="row">
                                                                                        <th class="text-center sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" style="width: 41px;" aria-label="#: activate to sort column ascending">#</th><th class="sorting" tabindex="0" rowspan="1" colspan="1" style="width: 143px;" aria-label="User Name: activate to sort column ascending">User Name</th><th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" style="width: 122px;" aria-label="Mobile: activate to sort column ascending">Mobile</th><th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" style="width: 211px;" aria-label="Email: activate to sort column ascending">Email</th><th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" style="width: 85px;" aria-label="Role: activate to sort column ascending">Role</th><th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" style="width: 143px;" aria-label="Created on: activate to sort column ascending">Created on</th><th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" style="width: 97px;" aria-label="Status: activate to sort column ascending">Status</th><th class="sorting_disabled" rowspan="1" colspan="1" style="width: 142px;" aria-label="Action">Action</th></tr>
                                                                                    </thead>                       
                                                                                    <tbody>
                                                                                    <tr role="row">
                                                                        <td class=" text-center" tabindex="0"> 1 </td>
                                                                                        <td> admin </td>
                                                                                        <td> 9845454454 </td>
                                                                        ...
                                                                        <td> 27-11-2018 </td>
                                                                        <td>
                                                                            <span class="label label-default" disabled="disabled" style="cursor:disabled">Restricted</span>
                                                                        </td>
                                                                            <td>
                                                                                <div class="btn-group" title="View Account">
                                                                                    ...
                                                                                    <li>
                                                                                    <a href="#"><i class="fa fa-fw fa-edit text-blue"></i>Edit</a></li></ul>
                                                                                </div>
                                                                            </td>
                                                        </tr><tr role="row" class="even">
                                                        <td class=" text-center" tabindex="0"> 2 </td>
                                                        <td> Sales </td>
                                                        <td> 24 </td>
                                                        ...
                                                        <td class=" text-center" tabindex="0"> 3 </td>
                                                        <td> Purchase </td>
                                                        <td> 98454547454 </td>
                                                        <td> purchase@gmail.com</td>
                                                        <td> Purchase </td>
                                                        <td> 02-07-2019 </td>
                                                        <td><span>Active</span>				
                                                        </td>
